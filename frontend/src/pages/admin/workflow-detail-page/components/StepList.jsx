...
export default function StepList({ steps, transitions, getRoleName, getActionName,
   getStepNameTo, 
   handleEditStep, removeStep, handleDeleteStep }) {
  return (
          ...
          <div key={step.step_id} className={styles.stepCard}>
            <div className={styles.stepHeader}>
              <div>
                ...
                <p className={styles.stepRole}>Role: {getRoleName(step.role_name)}</p>
              </div>
              <div className={styles.buttonGroup}>
                <button onClick={() => handleEditStep(step)} className={styles.editButton} >Edit</button>
                <button onClick={() => handleDeleteStep(step.step_id)} className={styles.removeButton}>Remove</button>
              </div>
            </div>
