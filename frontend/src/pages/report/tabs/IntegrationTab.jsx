...
export default function IntegrationTab({ displayStyle = "charts", analyticsData, loading, error }) {
          ...
          <div className={styles.listView}>
            <div className={styles.analyticsSection}>
              ...
              {reportData.integrations.map((integration, idx) => (
                <div key={idx} className={styles.listItem}>
                  <span className={styles.listLabel}>{integration.name}</span>
                  <span className={styles.listValue}>{integration.responseTime}</span>
                </div>
              ))}
            </div>
            <div className={styles.analyticsSection}>
              ...
              {reportData.integrations.map((integration, idx) => (
                <div key={idx} className={styles.listItem}>
                  <span className={styles.listLabel}>{integration.name}</span>
                  <span className={styles.listValue}>{(integration.errorRate * 100).toFixed(2)}%</span>
                </div>
              ))}
            </div>
          </div>
