...
// // UNSUED COMPONENT - KEPT FOR REFERENCE
// // 
// // 
// // 
// // 
...
//   // Get current user ID - only use AuthContext user
//   const currentUserId = authUser?.id;

//   // Helper function to determine if a message belongs to current user
//   const isOwnMessage = (message) => {
//     return currentUserId && message.user_id && String(currentUserId) === String(message.user_id);
//   };

//   // Helper function to get display name for a user
//   const getDisplayName = (message) => {
//     // For own messages, always show "You"
//     if (isOwnMessage(message)) {
//       return "You";
//     }
    
//     // For other messages, use sender or fallback to user_id
//     return message.sender || `User ${message.user_id}`;
//   };

//   // Helper function to get user initials for avatar
//   const getUserInitials = (message) => {
//     if (isOwnMessage(message)) {
//       // For current user, use their AuthContext data
...
//         }
//         return authUser.full_name[0]?.toUpperCase() || "Y";
//       }
//       return "Y"; // Default for "You"
//     } else {
//       // For other users, use sender name
//       const displayName = message.sender || `User ${message.user_id}`;
...
//     startTyping,
//     stopTyping,
//   } = useMessaging(ticket_id, authUser?.full_name);
...
//         {messages.map((m) => {
//           const senderValue = getDisplayName(m);
//           const senderRole = m.sender_role || null;
          
//           // Use helper function for message ownership detection
...
//                       <div className={styles.avatar} title={getDisplayName(m)}>
//                         {getUserInitials(m)}
//                       </div>
//                       <div className={styles.messageBubble}>
