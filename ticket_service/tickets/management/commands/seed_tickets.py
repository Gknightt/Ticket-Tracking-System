...
class Command(BaseCommand):
    help = "Seed the Ticket model with actual file-based attachments including full URLs"

    def handle(self, *args, **kwargs):
        self.stdout.write("📥 Seeding Tickets with actual attachments...")
        ...
        self.stdout.write(self.style.SUCCESS("🎉 Done seeding Ticket with real attachment URLs."))