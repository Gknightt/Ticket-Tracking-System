...
class Command(BaseCommand):
    help = 'Seed database with predefined roles and users using default cubecore27+N@gmail.com emails'
    ...
    def create_users(self):
        """Create five users using default cubecore27+N@gmail.com email format."""
        predefined_users = [
            {
                'first_name': 'Marc Cedric',
                'last_name': 'Mayuga',
                'middle_name': 'Cortes',
                'email': 'cubecore27@gmail.com',
                'username': 'marco',
